...
def client():
	...
	if status1[0] == 'Could not connect to server' and status2[0] == 'Could not connect to server' and status3[0] == 'Could not connect to server' and status4[0] == 'Could not connect to server':
